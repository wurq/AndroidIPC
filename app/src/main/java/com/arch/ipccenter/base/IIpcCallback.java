...
public static abstract class Stub extends Binder implements IIpcCallback {
    private static final java.lang.String DESCRIPTOR = "com.arch.ipccenter.base.IIpcCallback";
     ...
     */
    public static com.arch.ipccenter.base.IIpcCallback asInterface(android.os.IBinder obj) {
        if ((obj==null)) {
            return null;
        }
